...
This analysis focuses on interpretability rather than predictive optimisation, aiming to uncover actionable behavioural insights rather than maximise model accuracy.
...
| Feature | Description |
|------|------|
| event_value_in_usd | Total revenue generated by the user |
...
### 2. Promotion Paradox in Paid Traffic Context

Promotion clicks show a **negative association with revenue**.

β = **-0.59**

Interestingly, while **Paid Search traffic (CPC)** shows a positive association with revenue, **on-site promotional clicks remain negatively correlated**.

Interpretation: Paid traffic appears to bring high-intent users into the site, but intrusive or generic promotional elements may disrupt the purchase journey.

Strategic Action: Re-evaluate the promotion UX strategy. Instead of broad promotional banners, consider targeted offers aligned with user intent and landing page context.

---

### 3. Mobile-First Revenue Potential

Mobile devices show a slightly higher positive association with revenue compared to Desktop or Tablet in this dataset.
...
The chart below visualises the standardised regression coefficients, highlighting the relative importance of behavioural drivers in explaining revenue variation.
